...
const RadioButton: React.FC<Props> = ({ isSwitchOn, setIsSwitchOn }) => {
  return (
    <button
      className={`absolute top-0 right-0 w-10 h-5 px-px rounded-full flex justify-between items-center border ${isSwitchOn ? "bg-prime-violet border-prime-violet" : "bg-black border-black"}`}
