...
const Modal4 = () => {
  ...
  const [modalSize, setModalSize] = useState<SizeType>({
    outerDiv: "h-[30rem] w-[25rem] gap-3 sm:h-[32rem] sm:w-[29rem] sm:gap-5 px-14 ",
    badgeDiv: "h-24 w-24",
    badge: "h-[4rem] w-[3rem]",
    defSVG: "60",
    form: "gap-3",
  ...
  return (
    <div
      className={` font-secondary bg-white z-50 rounded-3xl shadow-lg shadow-gray-200 border border-gray-300  overflow-hidden flex flex-col justify-center items-center text-center sm:ml-3 lg:ml-8 relative ${isModalVisible} ${modalSize.outerDiv}`}
    >
      <div
