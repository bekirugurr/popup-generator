const popUp10 = (t) => {
    ...
    if (isItOkeyAboutDevice && isItOkeyAboutTrafficSource) {
      ...
      <div
      id='modalWrapper'
      class=" bg-white z-50 rounded-3xl shadow-lg shadow-gray-200 border border-gray-300 flex overflow-hidden fixed ${isVisible} ${modalSize.outerDiv} ${modalPosition}"
    >
      <div
